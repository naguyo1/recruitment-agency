<script>
  ...
  const company = {
    name: "JEPHTHAH Recruitment Agency",
    description:
  ...
  const jobs = [
    {
      ...
      image: "/images/maids.jpg"
    },
    {
      title: "Nurse Professionals",
      type: "Medical",
      country: "Qatar",
    ...
    },
    {
      ...
      type: "Health Care",
      country: "Canada",
      image: "/images/care takers.jpg"
    },
    {
      title: "Casual Workers",
      type: "General Labor",
      country: "Oman",
      image: "/images/casual workers.jpg"
    }
  ];
</script>
    ...
    {#each jobs as job}
      ...
      >
        <div class="overlay">
          ...
          <span class="badge">{job.country}</span>
        </div>
      </div>
    {/each}
  </div>
